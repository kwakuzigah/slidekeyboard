...
abstract public class Dictionary {
    ...
    public interface WordCallback {
         ...
         * @pararm isUserWord indicates if the word comes from the user dictionary
         * @return true if the word was added, false if no more words are required
         */
        boolean addWord(char[] word, int wordOffset, int wordLength, int frequency, boolean isUserWord);
    }
    ...
    /**
     * Checks if the given word is contained into the dictionary
     * @param word the word to search for. The search should be case-insensitive.
     * @return true if the word exists, false otherwise
     */
    abstract public boolean containsWord(CharSequence word);
